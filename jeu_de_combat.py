...
# variable par rapport au joueur et au statistiques
play = True
niveau_vie = 20
choix = 0
force_adversaire = 0
...
def genere_adv():  # génère un adversaire aléatoirement
    """

    :return: un adversaire aléatoire
    """
...
def menu():
    ...
    :return: Afficher le menu et permet de choisir une entrée
    """
    ...
    while afficher_menu:
        ...
        if choix == 3:
            # afficher les règlement
            print("\033[1;34m\n Pour réusir un combat , il faut que la valeur du dé lancé soit \n"
                  " supérieure à la force de l'adversaire."
                  " Dans ce cas, le niveau \n de vie de l'usager est augmenté de la force de"
                  " l'adversaire.\n Une défaite a lieu lorsque la valeur du dé lancé par l'usager"
                  " \n est inférieure ou égale à la fore de l'adversaire. Dans ce \n cas, le niveau"
                  " de vie de l'usager est diminué de la force de \n l'adversaire. \n \n L'usager peut"
                  " combattre ou éviter chaque adversaire, dans le \n cas de l'évitement, il y a une pénaltié"
                  " de 1 point de vie.\n\n\n\033[1;97m")
